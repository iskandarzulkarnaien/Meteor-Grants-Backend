...
def family6():
    ...
    husband = PersonBuilder(household).gender_male().married().employed(44000).adult().create_and_write()           # noqa: F841
...
def family7():
    ...
    husband = PersonBuilder(household).gender_male().married().employed(140000).adult().create_and_write()          # noqa: F841
